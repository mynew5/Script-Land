...
enum eCuergosTreasure
{
    ...
    GO_CUERGOS_TREASURE         = 142194,
    // PATHS NEED MORE WORK, WE NEED TWO GROUPS, MAYBE USING FORMATIONS?
    PIRPATH_ENTRY_1             = 2,
    PIRPATH_ENTRY_2             = 3,
    PIRPATH_ENTRY_3             = 4,
    PIRPATH_ENTRY_4             = 5,
