                    ...
                    switch(uiStage)
                    {
                        ...
                        case 11:
                        {
                            if(Creature* lich = Unit::GetCreature(*me, uiLichKingGUID))
                            {
                                ...
                                if(Unit* target = lich->SelectNearestTarget(100.0f))
...
enum eEvents
{
    ...
    public:
        ...
        struct npc_spirit_warden_iccAI : public ScriptedAI
        {
            ...
            void JustDied(Unit * /*pKiller*/)
            {
                if (Unit *player = me->SelectNearestTarget(80.0f))
                {
					Player *target;
                    ...
                    TeleportPlayerToFrozenThrone(target);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_DESTROY_SOUL:
                        {
                            ...
                            events.Reset();
                            Unit *player = me->SelectNearestTarget(80.0f);
