...
#define GOSSIP_HIPPOGRYPH       "Mount the Hippogryph and prepare for battle!"
...
bool GossipHello_npc_taxi(Player* pPlayer, Creature* pCreature)
{
    ...
    case 17209:
        ...
        break;
    case 35117:
        if (pPlayer->GetQuestStatus(14108) == QUEST_STATUS_INCOMPLETE)
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_HIPPOGRYPH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 31);
        break;
    }
...
bool GossipSelect_npc_taxi(Player* pPlayer, Creature* pCreature, uint32 /*uiSender*/, uint32 uiAction)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 31:
        pPlayer->CLOSE_GOSSIP_MENU();
        pPlayer->GetSession()->SendDoFlight(29627,1268);
        break;
    }
...
/*####
# npc taxi engineering
####*/

bool GossipHello_npc_taxi_engineering(Player* pPlayer, Creature* pCreature)
{
...
bool GossipSelect_npc_taxi_engineering(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
	int roll = 0;
    ...
    switch(uiAction) 
	{
		case GOSSIP_ACTION_INFO_DEF + 1: //Borean Tundra
			pPlayer->CLOSE_GOSSIP_MENU();
			roll = irand(0,1);
			if (roll == 0) pPlayer->TeleportTo(571, 4305.505859, 5450.839844, 63.005806, 0.627286);
			else pPlayer->TeleportTo(571, 3201.936279, 5630.123535, 133.658798, 3.855272);
        break;

		case GOSSIP_ACTION_INFO_DEF + 2: //Howling Fjord
			pPlayer->CLOSE_GOSSIP_MENU();
			pPlayer->CastSpell(pPlayer, 67838, true);
        break;

		case GOSSIP_ACTION_INFO_DEF + 3: //Sholazar Basin
			pPlayer->CLOSE_GOSSIP_MENU();
			pPlayer->CastSpell(pPlayer, 67835, true);
        break;

		case GOSSIP_ACTION_INFO_DEF + 4: //Icecrown
			pPlayer->CLOSE_GOSSIP_MENU();
			pPlayer->CastSpell(pPlayer, 67836, true);
        break;

		case GOSSIP_ACTION_INFO_DEF + 5: //Storm peaks
			pPlayer->CLOSE_GOSSIP_MENU();
			pPlayer->CastSpell(pPlayer, 67837, true);
        break;
	}
    return true;
}
...
void AddSC_npc_taxi()
{
    ...
    newscript = new Script;
    newscript->Name = "npc_taxi_engineering";
    newscript->pGossipHello = &GossipHello_npc_taxi_engineering;
    newscript->pGossipSelect = &GossipSelect_npc_taxi_engineering;
    newscript->RegisterSelf();
}
