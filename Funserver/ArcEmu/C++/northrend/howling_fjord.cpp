...
bool GossipHello_npc_moonleaf_and_mistwalker(Player* pPlayer, Creature* pCreature)
{
    if (pCreature->isQuestGiver())
        pPlayer->PrepareQuestMenu(pCreature->GetGUID());
...
bool GossipSelect_npc_moonleaf_and_mistwalker(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    switch(uiAction)
    {
...
void AddSC_howling_fjord()
{
    ...
    newscript = new Script;
    newscript->Name="npc_moonleaf_and_mistwalker";
    newscript->pGossipHello =  &GossipHello_npc_moonleaf_and_mistwalker;
    newscript->pGossipSelect = &GossipSelect_npc_moonleaf_and_mistwalker;
    newscript->RegisterSelf();
 }
