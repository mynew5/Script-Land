...
struct instance_oculus : public ScriptedInstance
{
    ...
    void SetData(uint32 type, uint32 data)
    {
		...
		{
		if (Creature* pProect = instance->GetCreature(uiProect))
		pProect->SummonGameObject(instance->IsHeroic()? CACHE_OF_EREGOS_H : CACHE_OF_EREGOS,1124.29, 1020.33, 602.70, 2.0,0, 0, 0, 0,90000000);
		}
                break;
        }
