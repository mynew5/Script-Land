...
UPDATE `creature_template` SET `unit_flags` =0 WHERE `entry`IN (39863, 39864, 39944, 39945);
UPDATE `creature_template` SET `type_flags` =0 WHERE `entry`IN (39863, 39864, 39944, 39945);