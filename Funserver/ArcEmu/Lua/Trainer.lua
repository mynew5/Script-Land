...
pUnit:GossipCreateMenu(10105, player, 0)

if (player:GetLevel() >= 80) then 
if (player:GetPlayerClass() == "Warrior") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",1,0) 
elseif (player:GetPlayerClass() == "Paladin") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",2,0) 
elseif (player:GetPlayerClass() == "Hunter") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",3,0) 
elseif (player:GetPlayerClass() == "Rogue") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",4,0) 
elseif (player:GetPlayerClass() == "Priest") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",5,0) 
elseif (player:GetPlayerClass() == "Death Knight") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",6,0) 
elseif (player:GetPlayerClass() == "Shaman") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",7,0) 
elseif (player:GetPlayerClass() == "Mage") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",8,0) 
elseif (player:GetPlayerClass() == "Warlock") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",9,0) 
elseif (player:GetPlayerClass() == "Druid") then 
pUnit:GossipMenuAddItem(0,"[Costs 1g] Learn me all my spells!",10,0) 
end 
end 
pUnit:GossipMenuAddItem(0,"Learn Professions",12,0)--762
pUnit:GossipMenuAddItem(5,"Learn Riding",13,0)
...
if (player:DealGoldCost(1) == false) then 
intid = 0 
...
if (intid == 12) then 
pUnit:GossipCreateMenu(10105, player, 0);
pUnit:GossipMenuAddItem(8, "enchanting", 96,0);
pUnit:GossipMenuAddItem(8, "tailoring", 95,0);
pUnit:GossipMenuAddItem(8, "engineering", 94,0);
pUnit:GossipMenuAddItem(8, "jewelcrafting", 93,0);
pUnit:GossipMenuAddItem(8, "alchemy", 92,0);
pUnit:GossipMenuAddItem(8, "black smith", 91,0);
pUnit:GossipMenuAddItem(8, "herbalism", 90,0);
pUnit:GossipMenuAddItem(8, "leather working", 89,0);
pUnit:GossipMenuAddItem(8, "mining", 80,0); --check
pUnit:GossipMenuAddItem(8, "skinning", 87,0);
pUnit:GossipMenuAddItem(8, "cooking", 86,0);
pUnit:GossipMenuAddItem(8, "first aid", 85,0);
pUnit:GossipMenuAddItem(8, "fishing", 84,0);
...
RegisterUnitGossipEvent(94945, 1, "On_Gossip") 
RegisterUnitGossipEvent(94945, 2, "On_Select")