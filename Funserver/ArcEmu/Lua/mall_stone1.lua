...
item:GossipMenuAddItem(3, "Blacksmithing Area", 973, 0)
...
item:GossipMenuAddItem(3, "SpaceMall", 974, 0)
item:GossipMenuAddItem(3, "SkyMall", 975, 0)
...
if(intid == 973) then
player:Teleport(0, -4800.085938, -1106.241455, 501.444305)
end

if(intid == 974) then
player:Teleport(616,-11.316591 ,17.381918 , 148.961823)
end

if(intid == 975) then
player:Teleport(0,-8876.205078 ,-510.804103 , 1189.705444)
end
