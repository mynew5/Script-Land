...
item:GossipMenuAddItem(10, "[-- Horde Boss Area --]", 19001, 0)
item:GossipMenuAddItem(10, "[-- InfinityWoW Horde Zones --]",500, 0)
item:GossipMenuAddItem(10, "[-- InfinityWoW Horde Citys --]",1, 0)
end
local race=player:GetPlayerRace()
if race==1 or race==3 or race==4 or race==7 or race==11 then
item:GossipMenuAddItem(10, "[-- Alliance Boss Area --]", 90002, 0)
item:GossipMenuAddItem(10, "[-- InfinityWoW Alliance Zones --]",400, 0)
item:GossipMenuAddItem(10, "[-- InfinityWoW Alliance Citys --]",2, 0)
end
item:GossipMenuAddItem(10, "[-- LEVELING AREAS --]", 2950, 0)
item:GossipMenuAddItem(10, "[-- Locations in Azeroth --]", 3, 0)
item:GossipMenuAddItem(10, "[-- Instances in Azeroth --]", 5, 0)
item:GossipMenuAddItem(10, "[-- Locations in Outland --]", 6, 0)
item:GossipMenuAddItem(10, "[-- Instances in Outland --]", 7, 0)
item:GossipMenuAddItem(10, "[-- InfinityWoW Arenas --]", 45,  0)
item:GossipMenuAddItem(10, "[-- Heal Me --]", 8080, 0)
item:GossipMenuAddItem(10, "[-- Items of InfinityWoW --]", 902, 0)
item:GossipMenuAddItem(10, "[-- Santhon World Boss --]", 1001, 0)
item:GossipMenuAddItem(10, "[-- Remove Ressurection Sickness --]", 9090, 0)
item:GossipMenuAddItem(10, "[-- Shadow Instance --]", 75000, 0)
player:SendBroadcastMessage("Use This Teleporter Device With Honor!")
...
player:SendAreaTriggerMessage("Using me in combat to escape thats noobie! Your health is lowered as Punishment!")
else
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "[-- Global Mall Zone --]", 6666, 0)
item:GossipMenuAddItem(10, "[-- Horde Mall Zone --]", 578, 0)
item:GossipMenuAddItem(10, "[-- Horde Quick Road 200-255 --]", 17070, 0)
item:GossipMenuAddItem(10, "[-- Horde Boss 255 --]", 19001, 0)
item:GossipMenuAddItem(10, "[-- Jamitos Level 200 Boss --]", 19000, 0)
item:GossipMenuAddItem(10, "[-- GM OFFICE --]", 118, 0)
player:SendAreaTriggerMessage("Have fun and remember to vote!")
item:GossipMenuAddItem(10, "|Main Menu|", 75, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 1502, 0)
item:GossipSendMenu(player)
else
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 15000, 0)
item:GossipSendMenu(player)
else
...
item:GossipMenuAddItem(10, "Go To Leveling Road", 29103, 0)
...
player:SendBroadcastMessage(""..player:GetName().." Why you wish to be teleported to such a low level area? Your waisting your time there!")
else
item:GossipCreateMenu(51, player, 0)
item:GossipMenuAddItem(10, "Go To Starting Road", 29101, 0)
player:SendAreaTriggerMessage("Have fun leveling and remember to vote!")
item:GossipSendMenu(player)
end
end
...
local race=player:GetPlayerRace()
if race==1 or race==3 or race==4 or race==7 or race==11 then
player:SendBroadcastMessage(""..player:GetName().." You can't go to Horde Starting road when your an enemy to the Horde!")
else
item:GossipCreateMenu(51, player, 0)
item:GossipMenuAddItem(10, "Go To Starting Road", 29030, 0)
player:SendAreaTriggerMessage("Have fun leveling and remember to vote!")
item:GossipSendMenu(player)
end
end
...
local race=player:GetPlayerRace()
if race==2 or race==5 or race==6 or race==8 or race==10 then
player:SendBroadcastMessage(""..player:GetName().." You can't go to Alliance Starting road when your an enemy to the Alliance!")
else
item:GossipCreateMenu(51, player, 0)
item:GossipMenuAddItem(10, "Go To Starting Road", 29060, 0)
player:SendAreaTriggerMessage("Have fun leveling and remember to vote!")
item:GossipSendMenu(player)
end
end
...
item:GossipCreateMenu(51, player, 0)
item:GossipMenuAddItem(10, "[-- Global Mall Zone --]", 6666, 0)
item:GossipMenuAddItem(10, "[-- Alliance Mall Zone --]", 567, 0)
item:GossipMenuAddItem(10, "[-- Jamitos Level 200 Boss --]", 11500, 0)
item:GossipMenuAddItem(10, "[-- Alliance Boss 255 --]", 90002, 0)
player:SendAreaTriggerMessage("Have fun and remember to vote!")
item:GossipMenuAddItem(10, "[-- GM OFFICE --]", 118, 0)
item:GossipMenuAddItem(10, "[-- Main Menu --]", 75, 0)
item:GossipSendMenu(player)
...
if (player:GetPlayerLevel() == 255) then
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 90003, 0)
item:GossipSendMenu(player)
else
player:SendAreaTriggerMessage("You must be level 255 to attack this boss!")
end
...
if (player:GetPlayerLevel() >= 200) then
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 1500, 0)
item:GossipSendMenu(player)
else
player:SendAreaTriggerMessage("You must be level 200 or higher to attack this boss!")
end
...
if (player:IsInCombat() == true) then
player:SetHealthPct(1)
player:SendAreaTriggerMessage("Using me in combat to escape tahts noobie! Your health is lowered as Punishment!")
else
item:GossipCreateMenu(51, player, 0)
item:GossipMenuAddItem(10, "|cffFF0000|--- |cff000000STARTING ROADS |cffFF0000---|", 2950, 0)
item:GossipMenuAddItem(10, "[-- Alliance Start Area --]", 2906, 0)
item:GossipMenuAddItem(10, "[-- Horde Start Area --]", 2903, 0)
item:GossipMenuAddItem(10, "[-- Global Starting Road --]", 29100, 0)
item:GossipMenuAddItem(10, "|cffFF0000|--- |cff000000INSTANCES |cffFF0000---|", 2950, 0)
item:GossipMenuAddItem(10, "[-- Cave of Rage 70-150 --]", 2951, 0)
item:GossipMenuAddItem(10, "[-- Lair of the Blackwing 150-255 --]", 2952, 0)
item:GossipMenuAddItem(10, "[-- Shadow of the Keep 100-200 --]", 2953, 0)
item:GossipMenuAddItem(10, "|cffFF0000|--- |cff000000LEVELING ROADS |cffFF0000---|", 2950, 0)
item:GossipMenuAddItem(10, "[-- Global: Path of the Damned --]", 29102, 0)
item:GossipMenuAddItem(10, "[-- Alpha: Quick Road 200-255 --]", 7070, 0)
item:GossipMenuAddItem(10, "[-- Omega: Quick Road 200-255 --]", 17070, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
if (player:GetPlayerLevel() == 255) then
item:GossipCreateMenu(51, player, 0)
item:GossipMenuAddItem(10, "[-- Gurubashi Arena --]", 777, 0)
item:GossipMenuAddItem(10, "[-- Blood Arena --]", 778, 0)
item:GossipMenuAddItem(10, "[-- Blood Ring --]", 779, 0)
item:GossipMenuAddItem(10, "[-- The Cube --]", 776, 0)
item:GossipMenuAddItem(10, "[-- The Maul --]", 709, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
...
item:GossipCreateMenu(51, player, 0)
item:GossipMenuAddItem(10, "[-- Orgrimmar --]", 10, 0)
item:GossipMenuAddItem(10, "[-- Undercity --]", 11, 0)
item:GossipMenuAddItem(10, "[-- Thunder Bluff --]", 12, 0)
item:GossipMenuAddItem(10, "[-- Silvermoon --]", 13, 0)
item:GossipMenuAddItem(10, "[-- Dalaran --]", 46,  0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipMenuAddItem(10, "[-- Stormwind --]", 14, 0)
item:GossipMenuAddItem(10, "[-- Ironforge --]", 15, 0)
item:GossipMenuAddItem(10, "[-- Darnassus --]", 16, 0)
item:GossipMenuAddItem(10, "[-- Exodar --]", 17, 0)
item:GossipMenuAddItem(10, "[-- Dalaran|", 46,  0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
...
item:GossipMenuAddItem(10, "|Eastern Kingdoms|", 40, 0)
item:GossipMenuAddItem(10, "|Kalimdor|", 41, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipMenuAddItem(10, "|Alterac Mountains|", 208, 0)
item:GossipMenuAddItem(10, "|Badlands|", 214, 0)
item:GossipMenuAddItem(10, "|Blasted Lands|", 222, 0)
item:GossipMenuAddItem(10, "|Burning Steppes|", 216, 0)
item:GossipMenuAddItem(10, "|Deadwind Pass|", 221, 0)
item:GossipMenuAddItem(10, "|Dun Morogh|", 212, 0)
item:GossipMenuAddItem(10, "|Duskwood|", 220, 0)
item:GossipMenuAddItem(10, "|Eastern Plaguelands|", 206, 0)
item:GossipMenuAddItem(10, "|Elwynn Forest|", 217, 0)
item:GossipMenuAddItem(10, "|Eversong Woods|", 201, 0)
item:GossipMenuAddItem(10, "|Ghostlands|", 202, 0)
item:GossipMenuAddItem(10, "-->Second Page-->", 43, 0)
item:GossipMenuAddItem(10, "|cff990000[Back]", 3, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
player:SendBroadcastMessage("You Cant Use Heal In Combat Noob! Your health is Lowered As Punishment!")
else
item:GossipMenuAddItem(10, "Hello i can heal you, but if you try to heal in combat ill get mad!", 8080, 0)
item:GossipMenuAddItem(10, "Is that a deal?!", 8081, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 8082, 0)
item:GossipSendMenu(player)
end
end
...
if (player:IsInCombat() == true) then
player:SetHealthPct(5)
player:SendAreaTriggerMessage("You Cant Use Heal In Combat Noob! Your health is Lowered As Punishment!")
else
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|Ashenvale|", 109, 0)
item:GossipMenuAddItem(10, "|Azuremyst Isle|", 103, 0)
item:GossipMenuAddItem(10, "|Bloodmyst Isle|", 102, 0)
item:GossipMenuAddItem(10, "|Darkshore|", 105, 0)
item:GossipMenuAddItem(10, "|Desolace|", 113, 0)
item:GossipMenuAddItem(10, "|Durotar|", 111, 0)
item:GossipMenuAddItem(10, "|Dustwallow Marsh|", 117, 0)
item:GossipMenuAddItem(10, "|Felwood|", 107, 0)
item:GossipMenuAddItem(10, "|Feralas|", 116, 0)
item:GossipMenuAddItem(10, "|Moonglade|", 106, 0)
item:GossipMenuAddItem(10, "|Mulgore|", 115, 0)
item:GossipMenuAddItem(10, "|Silithus|", 120, 0)
item:GossipMenuAddItem(10, "-->Second Page-->", 43, 0)
item:GossipMenuAddItem(10, "|cff990000[Back]", 3, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|Hillsbrad Foothills|", 210, 0)
item:GossipMenuAddItem(10, "|Loch Modan|", 213, 0)
item:GossipMenuAddItem(10, "|Redridge Mountains|", 218, 0)
item:GossipMenuAddItem(10, "|Searing Gorge|", 215, 0)
item:GossipMenuAddItem(10, "|Silverpine Forest|", 207, 0)
item:GossipMenuAddItem(10, "|Strangethorn Vale|", 223, 0)
item:GossipMenuAddItem(10, "|Swamp Of Sorrows|", 219, 0)
item:GossipMenuAddItem(10, "|The Hinterlands|", 209, 0)
item:GossipMenuAddItem(10, "|Trisfal Glades|", 205, 0)
item:GossipMenuAddItem(10, "|Western Plaguelands|", 203, 0)
item:GossipMenuAddItem(10, "|Wetlands|", 211, 0)
item:GossipMenuAddItem(10, "|cff990000[Back]", 3, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|Stonetalon Mountains|", 112, 0)
item:GossipMenuAddItem(10, "|Tanaris|", 121, 0)
item:GossipMenuAddItem(10, "|Teldrassil|", 100, 0)
item:GossipMenuAddItem(10, "|The Barrens|", 114, 0)
item:GossipMenuAddItem(10, "|Thousand Needles|", 118, 0)
item:GossipMenuAddItem(10, "|Un'Goro Crater|", 119, 0)
item:GossipMenuAddItem(10, "|cff990000[Back]", 3, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "Go Fight The Boss!", 10020, 0)
item:GossipMenuAddItem(10, "Now Now!", 9093, 0)
...
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 10021, 0)
item:GossipSendMenu(player)
else
player:SendBroadcastMessage("|cffFF0000You must have 1 [|cffFFFF05Gem of Immortal Power|cffFF0000] Its dropped by the level 255 Bosses! - |cffFF0000if you already have a gem, skip this message.")
player:GossipComplete()
...
if (player:GetPlayerLevel() == 255) then
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 10019, 0)
player:SendBroadcastMessage("|cffFF0000You must have 1 [|cffFFFF05Gem of Immortal Power|cffFF0000] Its dropped by the level 255 Bosses! - |cffFF0000if you already have a gem, skip this message.")
item:GossipSendMenu(player)
else
player:SendAreaTriggerMessage("You must be level 255 to attack this boss!")
...
if (player:GetPlayerLevel() == 255) then
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "|-------|", 75001, 0)
item:GossipSendMenu(player)
else
...
if player:HasItem(29750) then
item:GossipCreateMenu(55, player, 0)
item:GossipMenuAddItem(10, "-----", 75002, 0)
item:GossipSendMenu(player)
else
player:SendBroadcastMessage("|cffFF0000You must have 1 [|cffFFFF05Gem of Immortal Power|cffFF0000] Its dropped by the level 255 Bosses! - |cffFF0000if you already have a gem, skip this message.")
player:GossipComplete()
...
item:GossipMenuAddItem(10, "|Shadowfang Keep|", 19, 0)
item:GossipMenuAddItem(10, "|Zul'Gurub|", 20, 0)
item:GossipMenuAddItem(10, "|Scarlet Monastery|", 21, 0)
item:GossipMenuAddItem(10, "|Stratholme|", 22, 0)
item:GossipMenuAddItem(10, "|Scholomance|", 23, 0)
item:GossipMenuAddItem(10, "|Blackrock|", 24, 0)
item:GossipMenuAddItem(10, "|Onyxia's Lair|", 25, 0)
item:GossipMenuAddItem(10, "|Molten Core|", 26, 0)
item:GossipMenuAddItem(10, "|Karazhan|", 27, 0)
item:GossipMenuAddItem(10, "|Naxxramas|", 28, 0)
item:GossipMenuAddItem(10, "|Caverns Of Time|", 29, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipMenuAddItem(10, "|Hellfire|", 30, 0)
item:GossipMenuAddItem(10, "|Zangremarsh|", 31, 0)
item:GossipMenuAddItem(10, "|Nagrand|", 32, 0)
item:GossipMenuAddItem(10, "|Blades Edge|", 33, 0)
item:GossipMenuAddItem(10, "|Netherstorm|", 34, 0)
item:GossipMenuAddItem(10, "|Terokkar Forest|", 35, 0)
item:GossipMenuAddItem(10, "|Shadowmoon Valley|", 36, 0)
item:GossipMenuAddItem(10, "|Shattrath|", 37, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipMenuAddItem(10, "|Outland Raids|", 41, 0)
item:GossipMenuAddItem(10, "|Hellfire Ramparts|", 430, 0)
item:GossipMenuAddItem(10, "|The BloodFurnace|", 431, 0)
item:GossipMenuAddItem(10, "|Shattered Halls|", 441, 0)
item:GossipMenuAddItem(10, "|Mana-Tombs|", 434, 0)
item:GossipMenuAddItem(10, "|Sethekk Halls|", 438, 0)
item:GossipMenuAddItem(10, "|Auchenai Crypts|", 435, 0)
item:GossipMenuAddItem(10, "|Shadow Labyrinth|", 440, 0)
item:GossipMenuAddItem(10, "|cff990000-->Second Page-->", 47, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipMenuAddItem(10, "|Gruul's Lair|", 446, 0)
item:GossipMenuAddItem(10, "|Magtheridon's Lair|", 447, 0)
item:GossipMenuAddItem(10, "|Serpentshrine Cavern|", 449, 0)
item:GossipMenuAddItem(10, "|Black Temple|", 451, 0)
item:GossipMenuAddItem(10, "|Sunwell Plateau|", 452, 0)
item:GossipMenuAddItem(10, "|cff990000[Back]", 7, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
if(intid == 902) then
item:GossipCreateMenu(3543, player, 0)
item:GossipMenuAddItem(10, "World Of InfinityWoW Rule Book", 903, 0)
item:GossipMenuAddItem(10, "Starter Items", 8090, 0)
item:GossipMenuAddItem(10, "Shaman Totems", 1600, 0)
item:GossipMenuAddItem(10, "Ankh", 1601, 0)
item:GossipMenuAddItem(10, "x1 Arrows", 1903, 0)
item:GossipMenuAddItem(10, "x2 Arrows", 1904, 0)
item:GossipMenuAddItem(10, "x3 Arrows", 1905, 0)
item:GossipMenuAddItem(10, "x4 Arrows", 1906, 0)
item:GossipMenuAddItem(10, "x5 Arrows", 1907, 0)
item:GossipMenuAddItem(10, "Healing Apple", 1908, 0)
item:GossipMenuAddItem(10, "Pet Meat", 4000, 0)
item:GossipMenuAddItem(10, "Pet Cheese", 4001, 0)
item:GossipMenuAddItem(10, "Pet Fruit", 4002, 0)
item:GossipMenuAddItem(10, "Pet Cake", 4003, 0)
item:GossipMenuAddItem(10, "Soul Shards", 4004, 0)
item:GossipMenuAddItem(10, "Remove Shaman Totems", 16000, 0)
...
if(intid == 8090) then
item:GossipCreateMenu(59, player, 0)
item:GossipMenuAddItem(10, "|Starter Helmet|", 8091, 0)
item:GossipMenuAddItem(10, "|Starter Shoulder|", 8092, 0)
item:GossipMenuAddItem(10, "|Starter Chest|", 8093, 0)
item:GossipMenuAddItem(10, "|Starter Bracer|", 8094, 0)
item:GossipMenuAddItem(10, "|Starter Gloves|", 8095, 0)
item:GossipMenuAddItem(10, "|Starter Belt|", 8096, 0)
item:GossipMenuAddItem(10, "|Starter Pants|", 8097, 0)
item:GossipMenuAddItem(10, "|Starter Boots|", 8098, 0)
item:GossipMenuAddItem(10, "|Starter Sword|", 8099, 0)
item:GossipMenuAddItem(10, "|Starter Bow|", 8100, 0)
item:GossipMenuAddItem(10, "|Starter Bag|", 8101, 0)
item:GossipMenuAddItem(10, "|Starter Quiver|", 8102, 0)
item:GossipMenuAddItem(10, "[Back]", 902, 0)
item:GossipMenuAddItem(10, "[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end

if(intid == 8091) then
item:GossipMenuAddItem(10, "Main Menu", 8090, 0)
...
item:GossipMenuAddItem(10, "Main Menu", 902, 0)
player:GossipComplete()
end
...
item:GossipMenuAddItem(10, "|The Mechanar|", 442, 0)
item:GossipMenuAddItem(10, "|The Botanica|", 443, 0)
item:GossipMenuAddItem(10, "|The Arcatraz|", 444, 0)
item:GossipMenuAddItem(10, "|The Steamvault|", 439, 0)
item:GossipMenuAddItem(10, "|Slave Pens|", 432, 0)
item:GossipMenuAddItem(10, "|The Underbog|", 433, 0)
item:GossipMenuAddItem(10, "|cff990000[Back]", 7, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
...
item:GossipMenuAddItem(10, "Terrace of Light", 38, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
item:GossipMenuAddItem(10, "|Borean Tundra|", 501, 0)
item:GossipMenuAddItem(10, "|Crystalsong Forest|", 502, 0)
item:GossipMenuAddItem(10, "|Dalaran (City)|", 503, 0)
item:GossipMenuAddItem(10, "|Dragonblight|", 504, 0)
item:GossipMenuAddItem(10, "|Grizzly Hills|", 505, 0)
item:GossipMenuAddItem(10, "|Howling Fjord|", 506, 0)
item:GossipMenuAddItem(10, "|Icecrown|", 507, 0)
item:GossipMenuAddItem(10, "|Sholazar Basin|", 508, 0)
item:GossipMenuAddItem(10, "|The Storm Peaks|", 509, 0)
item:GossipMenuAddItem(10, "|Zul'Dark|", 510, 0)
item:GossipMenuAddItem(10, "|DK Start Zone|", 511, 0)
item:GossipMenuAddItem(10, "|cff990000[Main Menu]", 75, 0)
item:GossipSendMenu(player)
end
end
...
if(intid == 9090) then
item:GossipCreateMenu(500, player, 0)
item:GossipMenuAddItem(10, "You want me to remove your sickness?", 9090, 0)
item:GossipMenuAddItem(10, "Press here to Continue!", 9092, 0)
item:GossipSendMenu(player)
end
...
item:GossipMenuAddItem(10, "Sickness Removed Completely!", 9092, 0)
...
item:GossipCreateMenu(62, player, 0)
item:GossipMenuAddItem(10, "|cFF0000A0-EXIT-", 9093, 0)
item:GossipSendMenu(player)
