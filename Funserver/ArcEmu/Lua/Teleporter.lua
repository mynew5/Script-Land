...
unit:GossipMenuAddItem(2, "Mall", 303, 0)
unit:GossipMenuAddItem(2, "Natural Cities", 1, 0)
...
unit:GossipMenuAddItem(6, "PvP Arenas", 8, 0)
...
unit:GossipMenuAddItem(2, "Outland Locations", 5, 0)
unit:GossipMenuAddItem(2, "Northrend Locations", 6, 0)
unit:GossipMenuAddItem(3, "Event's", 7, 0)
unit:GossipMenuAddItem(6, "PvP Arenas", 8, 0)
unit:GossipMenuAddItem(2, "Custom Instances/Areas", 9, 0)
unit:GossipMenuAddItem(4, "Remove Ressurection sickness", 998, 0)
unit:GossipSendMenu(player)
end
...
unit:GossipCreateMenu(3000, player, 0)
unit:GossipMenuAddItem(0, "Stair Event", 700, 0)
...
if(intid == 303) then
player:Teleport(1, 9950.649414, 2340.353271, 1330.785400)
...
if(intid == 700) then
player:Teleport(mapid, xcoord, ycoord, zcoord)
unit:GossipComplete(player)
end
...
RegisterUnitGossipEvent(94944, 1, "On_Gossip")
RegisterUnitGossipEvent(94944, 2, "Gossip_Submenus")