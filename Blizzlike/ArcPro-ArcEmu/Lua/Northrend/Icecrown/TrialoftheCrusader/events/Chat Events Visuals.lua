...
function Tirion9_Talk(pUnit, Event)
	...
	pUnit:SpawnCreature(370004, pUnit:GetX(), pUnit:GetY(), pUnit:GetZ(), pUnit:GetO(), 35, 0)
end
...
function GarroshX_OnSpawn(pUnit, Event)
	pUnit:RegisterEvent("GarroshX_Talk", 15000, 1)
end

function Varian1_OnSpawn(pUnit, Event)
	pUnit:RegisterEvent("Varian1_Talk", 9000, 1)
end

function GarroshX_Talk(pUnit, Event)
	pUnit:SpawnCreature(370000, pUnit:GetX(), pUnit:GetY(), pUnit:GetZ(), pUnit:GetO(), 35, 0)
...
function Tirion10_OnSpawn(pUnit, Event)
	...
	pUnit:SpawnCreature(370001, pUnit:GetX(), pUnit:GetY(), pUnit:GetZ(), pUnit:GetO(), 35, 0)
...
function Garrosh1_OnSpawn(pUnit, Event)
...
function Varian2_OnSpawn(pUnit, Event)
	...
	pUnit:SpawnCreature(360960, pUnit:GetX(), pUnit:GetY(), pUnit:GetZ(), pUnit:GetO(), 35, 0)	
	pUnit:RegisterEvent("NPC_Despawn", 1000, 1)
end
...
function LichKing_Talk3(pUnit, Event)
  ...
  pUnit:PlaySoundToSet(16323)
    local floor = pUnit:GetGameObjectNearestCoords(pUnit:GetX(), pUnit:GetY(), pUnit:GetZ(), pUnit:GetO(), 195003);
	if(floor ~= nil) then
