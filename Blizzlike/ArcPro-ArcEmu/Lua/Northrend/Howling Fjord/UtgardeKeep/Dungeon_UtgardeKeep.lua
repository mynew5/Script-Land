...
function PrinceKeleseth_ShadowBolt(Unit, Event)
	Unit:FullCastSpellOnTarget(43667, Unit:GetMainTank())
end
...
function PrinceKeleseth_Skeletons(Unit, Event)
	...
	Unit:SpawnCreature(23970, Unit:GetX()+2, Unit:GetY(), Unit:GetZ(), Unit:GetO(), 14, 19000)
	Unit:SpawnCreature(23970, Unit:GetX(), Unit:GetY()+2, Unit:GetZ(), Unit:GetO(), 14, 19000)
	Unit:SpawnCreature(23970, Unit:GetX(), Unit:GetY(), Unit:GetZ()+2, Unit:GetO(), 14, 19000)
	Unit:SpawnCreature(23970, Unit:GetX()+3, Unit:GetY(), Unit:GetZ(), Unit:GetO(), 14, 19000)
	Unit:SpawnCreature(23970, Unit:GetX(), Unit:GetY(), Unit:GetZ()+3, Unit:GetO(), 14, 19000)
end
...
function PrinceKeleseth_FrostTomb(Unit, Event)
	...
	Unit:SpawnCreature(23965, Unit:GetX(), Unit:GetY(), Unit:GetZ(), Unit:GetO(), 14, 20000)
end
...
function Ingvar_Cleave(Unit, Event)
	Unit:FullCastSpellOnTarget(42724, Unit:GetMainTank())
end
...
function Ingvar_Roar(Unit, Event)
	Unit:FullCastSpellOnTarget(42708, Unit:GetMainTank())
end
	
function Ingvar_Smash(Unit, Event)
	Unit:FullCastSpellOnTarget(42669, Unit:GetMainTank())
end
...
function Ingvaru_Roar(Unit, Event)
	Unit:FullCastSpellOnTarget(42729, Unit:GetMainTank())
end
	
function Ingvaru_Smash(Unit, Event)
	Unit:FullCastSpellOnTarget(42723, Unit:GetMainTank())
end
