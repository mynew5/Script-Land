...
function buff(pUnit, Event)
	pUnit:SendChatMessage(12, 0, "Sacrilege! Defend the cathedral!") --Wrong saying? Does not seem blizzlike.
...
function hali(pUnit, Event)
	...
	pUnit:SendChatMessage(12, 0, "I won't stand for that!") --Wrong saying? Does not seem blizzlike.
end
...
function gelbin_OnKilledTarget (pUnit, Event)
	...
	pUnit:SendChatMessage(12, 0, "Pick on someone your own size!") --Wrong saying? Does not seem blizzlike.
end
...
function velen_OnDied(pUnit, event, player)
pUnit:RemoveEvents()
end
