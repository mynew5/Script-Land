...
function Event_part_1_training_say(Unit)
	Unit:SendChatMessage(12, 0, "Alright, alright! I think I can figure out how to operate this thing...")
end
...
function Event_part_1_main_path(Unit)
	...
	Unit:CreateWaypoint(1131.638, -3005.269, 91.549, 0.004, 120000, 0, 0)
