...
function Inquisitor_Weakness(Unit, Event)
    Unit:FullCastSpellOnTarget(11980, Unit:ClosestPlayer())
end

function Inquisitor_Flamestrike(Unit, Event)
    Unit:FullCastSpellOnTarget(36040, Unit:ClosestPlayer())
end
...
RegisterUnitEvent(19493, 2, "Inquisitor_OnLeaveCombat")
RegisterUnitEvent(19493, 4, "Inquisitor_OnDied")