...
function Archon_Flux(Unit, Event)
    Unit:FullCastSpellOnTarget(35924, Unit:ClosestPlayer())
end
...
function Archon_Overspark(Unit, Event)
    Unit:FullCastSpellOnTarget(35579, Unit:ClosestPlayer())
end

function Archon_Shadow(Unit, Event)
    Unit:FullCastSpellOnTarget(36515, Unit:ClosestPlayer())
end
...
RegisterUnitEvent(20458, 2, "Archon_OnLeaveCombat")
RegisterUnitEvent(20458, 4, "Archon_OnDied")