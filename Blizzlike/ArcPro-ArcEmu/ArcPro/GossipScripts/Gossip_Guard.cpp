...
class UndercityGuardOverseer : public Arcpro::Gossip::Script
{
	public:
		void OnHello(Object* pObject, Player* Plr)
		{
			Arcpro::Gossip::Menu menu(pObject->GetGUID(), 15321);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The auction house", 1);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The bank", 2);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Barber", 3);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The bat handler", 4);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The battlemaster", 5);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The guild master", 6);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The inn", 7);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Locksmith", 8);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The mailbox", 9);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The stable master", 10);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The weapon master", 11);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The zeppelin master", 12);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "A class trainer", 13);
			menu.AddItem(Arcpro::Gossip::ICON_CHAT, "A profession trainer", 14);
			menu.Send(Plr);
		}
		...
		void OnSelectOption(Object* pObject, Player* Plr, uint32 Id, const char * Code)
		{
			...
			case 1:     // The auction house
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14900, Plr);
					Plr->Gossip_SendPOI(1647.9f, 258.49f, 7, 99, 0, "Undercity Auction House");
				}break;
			case 2:     // The bank
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14901, Plr);
					Plr->Gossip_SendPOI(1595.64f, 232.45f, 7, 99, 0, "Undercity Bank");
				}break;
			case 3:     // Barber
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14902, Plr);
					Plr->Gossip_SendPOI(1576.20f, 193.14f, 7, 99, 0, "Undercity Barber");
				}break;
			case 4:     // The bat handler
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14903, Plr);
					Plr->Gossip_SendPOI(1565.9f, 271.43f, 7, 99, 0, "Undercity Bat Handler");
				}break;
			case 5:    // The battlemaster
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14904, Plr);
					Plr->Gossip_SendPOI(1300.33f, 350.92f, 7, 99, 0, "Battlemasters Undercity");
				}break;
			case 6:     // The guild master
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14911, Plr);
					Plr->Gossip_SendPOI(1594.17f, 205.57f, 7, 99, 0, "Undercity Guild Master");
				}break;
			case 7:     // The inn
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14913, Plr);
					Plr->Gossip_SendPOI(1639.43f, 220.99f, 7, 99, 0, "Undercity Inn");
				}break;
			case 8:     // Locksmith
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14916, Plr);
					Plr->Gossip_SendPOI(1499.68f, 53.28f, 7, 99, 0, "Undercity Locksmith");
				}break;
			case 9:     // The mailbox
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14918, Plr);
					Plr->Gossip_SendPOI(1632.68f, 219.4f, 7, 99, 0, "Undercity Mailbox");
				}break;
			case 10:     // The stable master
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14924, Plr);
					Plr->Gossip_SendPOI(1634.18f, 226.76f, 7, 99, 0, "Anya Maulray");
				}break;
			case 11:     // The weapon master
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14928, Plr);
					Plr->Gossip_SendPOI(1670.31f, 324.66f, 7, 99, 0, "Archibald");
				}break;
			case 12:     // The zeppelin master
				{
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14929, Plr);
					Plr->Gossip_SendPOI(2059.0f, 274.86f, 7, 99, 0, "Undercity Zeppelin");
				}break;
			case 13:    // A class trainer
				{
					Arcpro::Gossip::Menu menu(pObject->GetGUID(), 3542);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Mage"         , 15);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Paladin"      , 16);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Priest"       , 17);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Rogue"        , 18);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Warlock"      , 19);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Warrior"      , 20);
					menu.Send(Plr);
				}break;
			case 14:    // A profession trainer
				{
					Arcpro::Gossip::Menu menu(pObject->GetGUID(), 3541);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Alchemy"           , 21);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Blacksmithing"     , 22);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Cooking"           , 23);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Enchanting"        , 24);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Engineering"       , 25);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "First Aid"         , 26);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Fishing"           , 27);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Herbalism"         , 28);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Inscription"       , 29);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Leatherworking"    , 30);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Mining"            , 31);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Skinning"          , 32);
					menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Tailoring"         , 33);
					menu.Send(Plr);
				}break;
			case 15: //Mage
				{
					Plr->Gossip_SendPOI(1781.0f, 53.0f, 7, 99, 0, "Undercity Mage Trainers");
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 3513, Plr);
				}break;
			case 16: //Paladin
				{
					Plr->Gossip_SendPOI(1298.98f, 316.51f, 7, 99, 0, "Champion Cyssa Downrose");
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 3521, Plr);
				}break;
			case 17: //Priest
				{
			...
			case 18: //Rogue
				{
					...
					Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 3526, Plr);
				}break;
			case 19: //Warlock
				{
...
class DalaranGuard : public Arcpro::Gossip::Script
{
public:
	void OnHello(Object *pObject, Player *Plr)
	{
		Arcpro::Gossip::Menu menu(pObject->GetGUID(), 50000);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Arena"				,1);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Auction House"		,2);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Bank"				,3);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Barber"			,4);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Battlemasters"		,5);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Capital Portals"	,6);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Flight Master"		,7);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Guild Master"		,8);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Inn"				,9);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Locksmith"			,77);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Mailbox"			,10);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Points of Interest", 11);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Stable Master"		,12);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Trainers"			,13);
		menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Vendors"			,14);
		menu.Send(Plr);
	}
	...
	void OnSelectOption(Object *pObject, Player *Plr, uint32 Id, const char * Code)
	{
		...
		case 1:		// Arena
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 13976);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Eastern Sewer Entrance", 15);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Western Sewer Entrance", 16);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Well Entrance"			, 17);
				menu.Send(Plr);
			}break;
		case 2:		// Auction House
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 14010);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Alliance Quarter"	, 18);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Horde Quarter"		, 19);
				menu.Send(Plr);
			}break;
		case 3:		// Bank
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 14007);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Northern Bank"	, 20);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Southern Bank"	, 21);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Sewers"		, 22); // Sewers 1
				menu.Send(Plr);
			}break;
		case 4:		// Barber
			{
				Plr->Gossip_SendPOI(5889.67f, 621.21f, 7, 99, 0, "Barber");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14003, Plr);
			}break;
		case 5:		// Battlemasters
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 13977);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Alliance Quarter"	, 18);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Horde Quarter"		, 19);
				menu.Send(Plr);
			}break;
		...
		case 7:		// Flight Master
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 10086, Plr);
			}break;
		case 8:		// Guild Master
			{
				Plr->Gossip_SendPOI(5762.21f, 622.84f, 7, 99, 0, "Guild Master");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 10095, Plr);
			}break;
		case 9:		// Inn
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 14002);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Alliance Inn"	, 24);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Horde Inn"		, 25);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Sewers"		, 26); // Sewers 2
				menu.Send(Plr);
			}break;
		case 10:	// Mailbox
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 10090);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Inn"				, 9);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Bank"				, 3);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Krasus' Landing"	, 74);
				menu.Send(Plr);
			}break;
		case 11:	// Points of Interest
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 10056);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Alliance Quarter"	, 18);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Horde Quarter"		, 19);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Violet Citadel"	, 27);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Violet Hold"		, 28);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Sewers"				, 22); // Sewers 1
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Trade District"		, 29);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Krasus'Landing"		, 74);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Antonidas Memorial"	, 30);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Runeweaver Square"		, 31);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Eventide"			, 32);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Cemetary"				, 33);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Lexicon of Power"		, 34);
				menu.Send(Plr);
			}break;
		case 12:	// Stable Master
			{
				Plr->Gossip_SendPOI(5859.68f, 557.57f, 7, 99, 0, "Stable Master");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 10083, Plr);
			}break;
		case 13:	// Trainers
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 10082);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Class Trainer"			, 35);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Cold Weather Flying Trainer", 76);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Portal Trainer"		, 36);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Profession Trainer"	, 37);
				menu.Send(Plr);
			}break;
		case 14:	// Vendors
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 10173);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Armor"					, 38);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Clothing"				, 39);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Emblem Gear"			, 40);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Flowers"				, 41);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Fruit"					, 42);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "General Goods"			, 43);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Jewelry"				, 44);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Pet Supplies & Exotic Mounts", 45);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Pie, Pastry & Cakes"	, 46);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Reagents & Magical Goods", 47);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Toys"					, 48);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Trade Supplies"		, 43);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Trinkets. Relics & Off-hand items", 49);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Weapons"				, 50);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Wine & Cheese"			, 51);
				menu.Send(Plr);
			}break;
		case 15:	// Eastern Sewer Entrance
			{
				Plr->Gossip_SendPOI(5801.77f, 551.07f, 7, 99, 0, "Eastern Sewer Entrance");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13961, Plr);
			}break;
		case 16:	// Western Sewer Entrance
			{
				Plr->Gossip_SendPOI(5815.21f, 762.65f, 7, 99, 0, "Western Sewer Entrance");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13960, Plr);
			}break;
		case 17:	// Well Entrance
			{
				Plr->Gossip_SendPOI(5791.60f, 561.82f, 7, 99, 0, "Well Entrance");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13969, Plr);
			}break;
		case 18:	// The Alliance Quarter
			{
				Plr->Gossip_SendPOI(5763.20f, 711.77f, 7, 99, 0, "The Alliance Quarter");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13973, Plr);
			}break;
		case 19:	// The Horde Quarter
			{
				Plr->Gossip_SendPOI(5860.35f, 592.97f, 7, 99, 0, "The Horde Quarter");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13972, Plr);
			}break;
		case 20:	// Northern Bank
			{
				Plr->Gossip_SendPOI(5979.58f, 608.16f, 7, 99, 0, "Northern Bank");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14005, Plr);
			}break;
		case 21:	// Southern Bank
			{
				Plr->Gossip_SendPOI(5631.20f, 694.15f, 7, 99, 0, "Southern Bank");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14006, Plr);
			}break;
		case 22:	// Sewers 1
			{
				Plr->Gossip_SendPOI(5766.31f, 731.66f, 7, 99, 0, "Sewers");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13974, Plr);
			}break;
		case 24:	// Alliance Inn
			{
				Plr->Gossip_SendPOI(5718.01f, 689.28f, 7, 99, 0, "Alliance Inn");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13992, Plr);
			}break;
		case 25:	// Horde Inn
			{
				Plr->Gossip_SendPOI(5890.22f, 500.58f, 7, 99, 0, "Horde Inn");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13993, Plr);
			}break;	
		case 26:	// Sewers 2
			{
		...
		case 36:	// Portal Trainer
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13999, Plr);
			}break;
		case 37:	// Profession Trainer
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 13996);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Alchemy"		, 52);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Blacksmithing"	, 53);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Cooking"		, 54);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Enchanting"	, 55);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "engineering"	, 56);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "First Aid"		, 57);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Fishing"		, 58);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Herbalism"		, 59);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Inscription"	, 60);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Jewelcrafting"	, 61);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Leatherworking", 62);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Mining"		, 63);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Skinning"		, 64);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Tailoring"		, 65);
				menu.Send(Plr);
			}break;
		case 38:	// Armor
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 14117);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Cloth Armor"          , 66);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Leather Armor"          , 67);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Mail Armor"          , 68);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Plate Armor"          , 69);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Shields"          , 70);
				menu.Send(Plr);
			}break;
		case 39:	// Clothing
			{
				Plr->Gossip_SendPOI(5793.11f, 686.44f, 7, 99, 0, "Clothing");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14112, Plr);
			}break;
		case 40:	// Emblem Gear
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 14108);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Alliance Quarter"          , 18);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "The Horde Quarter"          , 19);
				menu.Send(Plr);
			}break;
		case 41:	// Flowers
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 10159, Plr);
			}break;
		case 42:	// Fruit
			{
				Plr->Gossip_SendPOI(5754.02f, 694.18f, 7, 99, 0, "Fruit");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14106, Plr);
			}break;
		case 43:	// General Goods
			{
				Plr->Gossip_SendPOI(5681.22f, 616.57f, 7, 99, 0, "General Goods");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14105, Plr);
			}break;
		case 44:	// Jewelry
			{
				Plr->Gossip_SendPOI(5874.27f, 719.18f, 7, 99, 0, "Portal Trainer");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13984, Plr);
			}break;
		case 45:	// Pet Supplies & Exotic Mounts
			{
				Plr->Gossip_SendPOI(5833.13f, 572.72f, 7, 99, 0, "Pet Supplies & Exotic Mounts");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14103, Plr);
			}break;
		case 46:	// Pie, Pastry & Cakes
			{
				Plr->Gossip_SendPOI(5905.86f, 629.29f, 7, 99, 0, "Pie, Pastry & Cakes");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14102, Plr);
			}break;
		case 47:	// Reagents & Magical Goods
			{
				Plr->Gossip_SendPOI(5758.7f, 737.24f, 7, 99, 0, "Reagents & Magical Goods");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14104, Plr);
			}break;
		case 48:	// Toys
			{
				Plr->Gossip_SendPOI(5813.48f, 688.49f, 7, 99, 0, "Toys");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14100, Plr);
			}break;
		case 49:	// Trinkets. Relics & Off-hand items
			{
				Plr->Gossip_SendPOI(5755.53f, 642.03f, 7, 99, 0, "Trinkets. Relics & Off-hand items");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14110, Plr);
			}break;
		case 50:	// Weapons
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 14113);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Melee Weapons"          , 71);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Ranged & Thrown Weapons"          , 72);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Staves & Wands"          , 73);
				menu.Send(Plr);
			}break;
		case 51:	// Wine & Cheese
			{
				Plr->Gossip_SendPOI(5885.66f, 606.89f, 7, 99, 0, "Wine & Cheese");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14095, Plr);
			}break;
		case 52:	// Alchemy
			{
				Plr->Gossip_SendPOI(5888.05f, 702.44f, 7, 99, 0, "Alchemy");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13995, Plr);
			}break;
		case 53:	// Blacksmithing
			{
				Plr->Gossip_SendPOI(5904.86f, 680.12f, 7, 99, 0, "Blacksmithing");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13994, Plr);
			}break;
		case 54:	// Cooking
			{
				Arcpro::Gossip::Menu menu(pObject->GetGUID(), 13991);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Alliance Inn"          , 24);
				menu.AddItem(Arcpro::Gossip::ICON_CHAT, "Horde Inn"          , 25);
				menu.Send(Plr);
			}break;
		case 55:	// Enchanting
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13990, Plr);
			}break;
		case 56:	// Engineering
			{
				Plr->Gossip_SendPOI(5922.55f, 727.05f, 7, 99, 0, "Engineering");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13989, Plr);
			}break;
		case 57:	// First Aid
			{
				Plr->Gossip_SendPOI(5862.76f, 743.71f, 7, 99, 0, "First Aid");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13988, Plr);
			}break;
		case 58:	// Fishing
			{
				Plr->Gossip_SendPOI(5707.45f, 614.57f, 7, 99, 0, "Fishing");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13987, Plr);
			}break;
		case 59:	// Herbalism
			{
				Plr->Gossip_SendPOI(5873.99f, 689.44f, 7, 99, 0, "Herbalism");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13986, Plr);
			}break;
		case 60:	// Inscription
			{
				Plr->Gossip_SendPOI(5861.8f, 704.3f, 7, 99, 0, "Inscription");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13985, Plr);
			}break;
		...
		case 62:	// Leatherworking
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13982, Plr);
			}break;
		case 63:	// Mining
			{
				Plr->Gossip_SendPOI(5923.27f, 709.86f, 7, 99, 0, "Mining");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13983, Plr);
			}break;
		case 64:	// Skinning
			{
		...
		case 65:	// Tailoring
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 13981, Plr);
			}break;
		case 66:	// Cloth Armor
			{
		...
		case 67:	// Leather Armor
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14111, Plr);
			}break;
		case 68:	// Mail Armor
			{
		...
		case 69:	// Plate Armor
			{
				...
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14109, Plr);
			}break;
		case 70:	// Shields
			{
		...
		case 76:	// Cold weather flying trainer
			{
				Plr->Gossip_SendPOI(5815.91f, 453.64f, 7, 99, 0, "Flight Master");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 60059, Plr);
			}break;
		case 77:	// Locksmith
			{
				Plr->Gossip_SendPOI(5934.0f, 575.626f, 7, 99, 0, "Dalaran Locksmith");
				Arcpro::Gossip::Menu::SendSimpleMenu(pObject->GetGUID(), 14004, Plr);
			}break;
		}
	}
};
...
void SetupGuardGossip(ScriptMgr* mgr)
{
	...
	//Dalaran guards
	Arcpro::Gossip::Script * DalaranGossip = new DalaranGuard;
