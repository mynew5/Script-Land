...
function Freya_Elder1Check(pUnit, Event)
	if(Elder1D == 0) then
		...
		Freya:RegisterEvent("Freya_Elder1D", 26000, 0)
	else
	end
end
...
function Freya_Elder2Check(pUnit, Event)
	if(Elder2D == 0) then
		...
		Freya:RegisterEvent("Freya_Elder2D", 6000, 0)
	else
	end
end
...
function Freya_Elder3Check(pUnit, Event)
	if Elder3D == 0 then
		...
		Freya:RegisterEvent("Freya_Elder3D", 30000, 0)
	else
	end
end
...
function Freya_Swarm(pUnit, Event)
	...
	Freya:SpawnCreature(99806, Freya:GetX()+8, Freya:GetY()+8, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()+9, Freya:GetY()+9, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()+10, Freya:GetY()+10, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()-8, Freya:GetY()-8, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()-9, Freya:GetY()-9, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()-10, Freya:GetY()-10, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()+11, Freya:GetY()-11, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()+12, Freya:GetY()-12, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()+10, Freya:GetY()-15, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99806, Freya:GetX()-12, Freya:GetY()+9, Freya:GetZ(), Freya:GetO(), 16, 600000)
end
...
function Freya_Elder(pUnit, Event)
	...
	Freya:SpawnCreature(99807, Freya:GetX()+15, Freya:GetY()-15, Freya:GetZ(), Freya:GetO(), 16, 600000)
end
...
function Freya_Elements(pUnit, Event)
	...
	Freya:SpawnCreature(99808, Freya:GetX()+10, Freya:GetY()+10, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99809, Freya:GetX()-10, Freya:GetY()-10, Freya:GetZ(), Freya:GetO(), 16, 600000)
	Freya:SpawnCreature(99810, Freya:GetX()+15, Freya:GetY()+15, Freya:GetZ(), Freya:GetO(), 16, 600000)
end
