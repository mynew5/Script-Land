...
function Torseldori_ArcaneMissiles(Unit, Event)
	Unit:FullCastSpellOnTarget(22273, Unit:ClosestPlayer())
end

function Torseldori_Blizzard(Unit, Event)
	Unit:FullCastSpellOnTarget(33634, Unit:ClosestPlayer())
end

function Torseldori_FrostNova(Unit, Event)
	Unit:FullCastSpellOnTarget(12674, Unit:ClosestPlayer())
end

function Torseldori_Frostbolt(Unit, Event)
	Unit:FullCastSpellOnTarget(15530, Unit:ClosestPlayer())
end
...
function Xintor_IceBarrier(Unit, Event)
	Unit:FullCastSpellOnTarget(33245, Unit:ClosestPlayer())
end
...
function Arzeth_ShadowBoltVolley(Unit, Event)
	Unit:FullCastSpellOnTarget(15245, Unit:ClosestPlayer())
end
...
function Avruu_Darkness(Unit, Event)
	Unit:FullCastSpellOnTarget(34112, Unit:ClosestPlayer())
end
...
function BatRiderGuard_UnstableConcoction(Unit, Event)
	Unit:FullCastSpellOnTarget(38066, Unit:ClosestPlayer())
end
...
function BHDS_FireNova(Unit, Event)
	Unit:FullCastSpellOnTarget(32062, Unit:ClosestPlayer())
end
...
function BHGrunt_Strike(Unit, Event)
	Unit:FullCastSpellOnTarget(11976, Unit:ClosestPlayer())
end
...
function BHT_OnEnterCombat(Unit, Event)
	...
	Unit:FullCastSpellOnTarget(33924, Unit:RandomPlayer(3))
end
...
function BR_Spell(Unit, Event)
	Unit:FullCastSpellOnTarget(32722, Unit:ClosestPlayer())
end
...
function BWM_OnEnterCombat(Unit, Event)
	Unit:FullCastSpellOnTarget(34113, Unit:ClosestPlayer())
...
function BWM_Enrage(Unit, Event)
	Unit:FullCastSpellOnTarget(8599, Unit:ClosestPlayer())
end
...
function BCRW_Howl(Unit, Event)
	Unit:FullCastSpellOnTarget(3149, Unit:ClosestPlayer())
end

function BCRW_Bite(Unit, Event)
	Unit:FullCastSpellOnTarget(16460, Unit:ClosestPlayer())
end
...
function Scavenger_Spell(Unit, Event)
	Unit:FullCastSpellOnTarget(13398, Unit:ClosestPlayer())
end
...
function Buzzard_Spell(Unit, Event)
	Unit:FullCastSpellOnTarget(37012, Unit:ClosestPlayer())
end
...
function CollapsingVoidwalker_Fear(Unit, Event)
	Unit:FullCastSpellOnTarget(34259, Unit:ClosestPlayer())
end
...
function CrustBurster_Bore(Unit, Event)
	Unit:FullCastSpellOnTarget(32738, Unit:ClosestPlayer())
end

function CrustBurster_Poison(Unit, Event)
	Unit:FullCastSpellOnTarget(31747, Unit:ClosestPlayer())
end
...
function CursedScarab_OnEnterCombat(Unit, Event)
	Unit:FullCastSpellOnTarget(3256, Unit:ClosestPlayer())
end
...
function CollapsingVoidwalker_OnDied(Unit, Event)
	Unit:CastSpell(34302)
	Unit:CastSpell(34233)
	Unit:FullCastSpellOnTarget(34234, Unit:ClosestPlayer())
	Unit:CastSpell(34842)
	Unit:RemoveEvents()
end
